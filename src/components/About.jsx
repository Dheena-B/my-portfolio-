    ...
    <div id="about" className="bg-[#ffffff] min-h-screen flex items-center">
      <div className="max-w-[90%] md:max-w-[75%] mx-auto font-inter space-y-10 py-10">
        ...
        <p className="text-lg md:text-xl text-gray-700 text-center leading-relaxed">
          I’m <span className="font-bold text-[#fe5617]">DheenaDhyalan</span>,
          ...
          as a content creator, As a passionate
          <span className="font-bold text-[#fe5617]"> Front-End Developer</span> on
          with over 2 years of experience, I specialize in creating intuitive, responsive, and accessible web interfaces using HTML, CSS, and JavaScript.
           I have experience with modern frameworks like React, Angular, and Vue.js,
           and I am proficient in front-end tools such as Webpack, Sass, and Git. 
           My goal is to combine creativity with functionality, designing web applications that not only look great but also provide seamless and engaging user experiences.
